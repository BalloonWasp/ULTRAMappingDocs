...
### Tags:
1. Wall - for walls;
2. Floor - for floors and ceilings.
### Layers
1. Environment - for all of geometry;
2. Outdoors - for geometry that is located in the 'outdoors' section of the level, used for lighting purposes.