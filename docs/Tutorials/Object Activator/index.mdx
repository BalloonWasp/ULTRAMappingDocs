---
title: Object Activators and Triggers
sidebar_position: 5
---
...
In order to create a basic trigger, first, create an empty gameobject. Afterwards, give it a Box Collider component and check the Is Trigger field. Now you can add Object Activator and use it, or directly add a component you want to activate to the gameobject. For ease of use, you can add Mesh Rendered component, add a material to it, set the layer to Invisible and save it as a prefab. 

---

This gameobject runs a [ULTRAKILL Event](./Object%20Activator/ULTRAKILL%20Event/)
